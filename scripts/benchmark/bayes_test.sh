#!/bin/bash
# 30-minute substantial BO test. Array task k runs seed (42+k).
# Single-GPU version: avoids multiprocessing noise for validation of the final config.
#SBATCH --job-name=ml4chem-bayes
...
OUTPUT_DIR="output/simulation/run_tests/coarse_bo_30m_test"
