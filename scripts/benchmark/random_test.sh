#!/bin/bash
# 30-minute substantial random-search test. Array task k runs seed (42+k).
# Single-GPU version: avoids multiprocessing noise for validation of the final config.
#SBATCH --job-name=ml4chem-random-test
...
OUTPUT_DIR="output/simulation/run_tests/coarse_random_30m_test"
