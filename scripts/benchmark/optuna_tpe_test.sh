#!/bin/bash
# 30-minute substantial Optuna TPE test. Array task k runs seed (42+k).
# Single GPU: this script runs one TPE study per Slurm task.
#SBATCH --job-name=ml4chem-optuna-tpe-test
...
OUTPUT_DIR="output/simulation/run_tests/coarse_tpe_30m_test"
