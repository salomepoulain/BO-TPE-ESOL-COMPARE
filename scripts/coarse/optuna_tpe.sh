#!/bin/bash
# Array task k runs seed (42+k). All HPO storage on local SSD ($TMPDIR),
# rsynced to output/simulation/<run>/ at the end.
#SBATCH --job-name=ml4chem-optuna-tpe
...
OUTPUT_DIR="output/simulation/coarse_tpe"
